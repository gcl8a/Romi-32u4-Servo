...
#define MIN_PULSE_WIDTH       800u     // the shortest pulse sent to a servo  
#define MAX_PULSE_WIDTH      2200u     // the longest pulse sent to a servo 
#define DEFAULT_PULSE_WIDTH  1500u     // default pulse width when servo is attached
#define REFRESH_INTERVAL    20000u     // minimum time to refresh servos in microseconds 
